extends TileCard
## +60 Flavour. +10% spoil chance after every completed fire this hour
## Should it be a fixed spoil chance instead, is this card worth the risk?
...
func get_board_chip(_tile: Hex = null) -> Dictionary:
	return _amount_board_chip(60, ICON_FLAVOUR)
